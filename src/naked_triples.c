...
int naked_triples(SudokuBoard *p_board)
{
    ...
    {
        find_naked_triples(p_board->p_rows[i], naked_triples, &total);
        find_naked_triples(p_board->p_cols[i], naked_triples, &total);
        find_naked_triples(p_board->p_boxes[i], naked_triples, &total);
    }

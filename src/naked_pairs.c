...
int naked_pairs(SudokuBoard *p_board)
{
    ...
    {
        find_naked_pairs(p_board->p_rows[i], naked_pairs, &total);
        find_naked_pairs(p_board->p_cols[i], naked_pairs, &total);
        find_naked_pairs(p_board->p_boxes[i], naked_pairs, &total);
   }
